/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd85a3cc1891573ae9ca89d0704be106)
// Runtime types generated with workerd@1.20260903.1 2026-08-18 
interface __BaseEnv_Env {
	...
	BUILD_SHA: "";
	LOOP: DurableObjectNamespace<import("./src/index").LoopRoom>;
	COORDINATOR: DurableObjectNamespace<import("./src/index").Coordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LoopRoom" | "Coordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODE" | "MAX_QUESTIONS" | "DAILY_NEURON_CEILING" | "BUILD_SHA">> {}
}
